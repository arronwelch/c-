...
int main(void)
{
	...
	if (pia != ia+asize)
		// found ...
		cout << "found " << search_value << " in int array" << endl;
	else
		cout << "not found " << search_value << " in int array" << endl;
	...
	if (ivec_iter != ivec.end())
		// found ...
		cout << "found " << search_value << " in int vector" << endl;
	else
		cout << "not found " << search_value << " in int vector" << endl;
	...
	if (ilist_iter != ilist.end())
		// found ...
		cout << "found " << search_value << " in int list" << endl;
	else
		cout << "not found " << search_value << " in int list" << endl;
